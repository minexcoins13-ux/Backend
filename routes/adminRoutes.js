...
const { getAllUsers, getPendingDeposits, approveDeposit, deleteDeposit, updateUserStatus, getPendingKyc, approveKyc, rejectKyc } = require('../controllers/adminController');
